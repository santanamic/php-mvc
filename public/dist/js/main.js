...
var initBootstrap = function initBootstrap(config) {
  // Enabling tooltips
  if (config.tooltip) {
    ...
    toastTriggerList.map(function (toastTriggerEl) {
      ...
      if ("A" === toastTriggerEl.nodeName) {
        ...
        if (toastTarget.includes('#')) {
          toastTarget = "#".concat(toastTarget.split("#").pop());
        } else {
          return;
        }
      ...
      var toastTargetEl = document.querySelector(toastTarget);
      ...
      var toast = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Toast(toastTargetEl); // Add click even to trigger
...
(0,_bootstrap__WEBPACK_IMPORTED_MODULE_1__.initBootstrap)({
  tooltip: true,
  popover: true,
  toasts: true
}); // Your app code
